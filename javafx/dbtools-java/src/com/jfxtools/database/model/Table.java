...
public class Table extends DatabaseObject implements ITable {
	...
	public Table() {
		this(null, null, Messages.getString("Table.0")); 
	}
	...
	public synchronized ITableData getData() {
		...
		// }
		return (ITableData) new TableData(this);
	}

	public String getQualifiedName() throws SQLException {
		if (getSchema() != null) {
			String schemaName = quoteIdentifier(getDatabaseInfo(), getSchema()
					.getName());
			String tableName = quoteIdentifier(getDatabaseInfo(), getName());
