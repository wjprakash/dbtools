...
public interface IConnectionType {
	...
	public static final String TEMPLATE_HOST = "<HOST>"; //$NON-NLS-1$
	public static final String TEMPLATE_PORT = "<PORT>"; //$NON-NLS-1$
	public static final String TEMPLATE_DB = "<DB>"; //$NON-NLS-1$
	public static final String TEMPLATE_DB_PATH = "<DB_PATH>"; //$NON-NLS-1$
