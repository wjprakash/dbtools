 ...
 * @version 1.0
 */
public class RelationshipConnectionSourceAnchor extends
		AbstractConnectionAnchor {

	public RelationshipConnectionSourceAnchor() {
		super();
	}

	public RelationshipConnectionSourceAnchor(IFigure owner) {
		super(owner);
	}
